...
-- INSERT INTO ACTION_ON_PAWN VALUES (0, 'INCREMENT_VALUE', 0);
-- INSERT INTO ACTION_ON_PAWN VALUES (1, 'INCREMENT_VALUE', 1);
--
-- INSERT INTO increment_value_on_pawn VALUES (0, 20);
-- INSERT INTO increment_value_on_pawn VALUES (1, 20);


INSERT INTO ACTION_ON_PAWN VALUES (2, 'MOVE', 0);

INSERT INTO MOVE_ON_PAWN VALUES (2, 10000, 10000);

ALTER SEQUENCE seq_action_on_pawn RESTART WITH 3;