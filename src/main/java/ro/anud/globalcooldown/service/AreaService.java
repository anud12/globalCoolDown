...
public class AreaService {
    ...
    public Area getTotalArea() {
        ...
        points.add(new Point(50000, 1000));
        points.add(new Point(25000, 25000));
        points.add(new Point(50000, 50000));
        points.add(new Point(1000, 50000));
        ...
        lines.add(Line.builder().start(new Point(25000, 25000)).end(new Point(50000, 50000)).build());
